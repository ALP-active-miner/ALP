...
def _semantic_feasibility(self, G1_node, G2_node):
    ...
    if self.edge_match is not None:
        ...
        if self.test == 'mono':
            core_2 = self.core_2
            # 
            for neighbor in G2_adj[G2_node]:
                ...
                if neighbor == G2_node:
                    if not edge_match(G1_adj[G1_node][G1_node],
                        ...
                        return False
                elif neighbor in core_2:
                    if not edge_match(G1_adj[G1_node][core_2[neighbor]], G2_adj[G2_node][neighbor]):
                        return False
            ...
            for neighbor in G1_adj[G1_node]:
                ...
                if neighbor == G1_node:
                    ...
                    if not edge_match(G1_adj[G1_node][neighbor], G2_adj[G2_node][core_1[neighbor]]):
                        return False
