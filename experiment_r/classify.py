...
def train_model():
	# feature_vector_path = sys.argv[1] # "/Users/first_author/repos/MUDetect/src2egroum2aug/output/java.io.ByteArrayOutputStream__toByteArray__0_formatted.txt_result_features.txt"
...
def read_selected_subgraph_ids():
	subgraph_ids = []
	# best_subgraphs_path =sys.argv[2] # "/Users/first_author/repos/MUDetect/src2egroum2aug/output/java.io.ByteArrayOutputStream__toByteArray__0_formatted.txt_result_best_subgraphs.txt"
...
def read_subgraph_features():
	subgraphs = []
	# subgraphs_path = sys.argv[3] # "/Users/first_author/repos/MUDetect/src2egroum2aug/output/java.io.ByteArrayOutputStream__toByteArray__0_formatted.txt_result"
...
for model in models:
	print('model' , model)
	outliers = novelty_detectors[0].predict(test_vector)
	outlier_score = novelty_detectors[0].score_samples(test_vector)
